...
public abstract class Conta {
	...
	public void cancelar() throws OperacaoContaException {
		if (SituacaoConta.PAGA.equals(getSituacaoConta())) {
			throw new OperacaoContaException("Uma conta não pode ser cancelada se já está paga: " + this.getDescricao());
		} else if (SituacaoConta.CANCELADA.equals(getSituacaoConta())) {
			throw new OperacaoContaException("Uma conta não pode ser cancelada se já está cancelada: " + this.getDescricao());
		} else {
